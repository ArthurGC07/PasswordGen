Quick note to ensure things work as they should: You will need to configure the password and email settings so that the 'Reset password' functionality actually works.
